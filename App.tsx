...
import { BotonCero, BotonOperacion } from './src/components/BotonOperacion';
...
export default function App() {
  ...
  const {formula, numeroAnterior, construirNumero, clean, cambiarSigno, borrarDigito, operaciones,resultado  } = useCalculadora();
  ...
  return (
    ...
    <View style={GlobalStyles.fila}>
      ...
      <BotonOperacion label='.' width={80} onPress={() =>construirNumero('.')}type='especial'></BotonOperacion>
    ...
    <View style={GlobalStyles.fila}>
      <BotonCero label='0' width={180} onPress={() =>construirNumero('0')}type='cero'></BotonCero>
